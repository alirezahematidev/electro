...
* @returns {string}
*/
module.exports.firstName = function(locale) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.firstName(retptr, ptr0, len0);
...
* @returns {string}
*/
module.exports.lastName = function(locale) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = isLikeNone(locale) ? 0 : passStringToWasm0(locale, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.lastName(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
...
const path = require('path').join(__dirname, 'main_bg.wasm');
